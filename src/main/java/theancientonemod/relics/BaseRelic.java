...
import static theancientonemod.ancientOneMod.relicPath;
...
public abstract class BaseRelic extends CustomRelic {
    ...
    public BaseRelic(String id, String imageName, RelicTier tier, LandingSound sfx) {
        super(testStrings(id), hasPrefix(id) ? "" : imageName, tier, sfx);
    ...
    private static boolean hasPrefix(String id) {
        return id.startsWith(ancientOneMod.modID); //your main class name is different use that
    }
