...
import theancientonemod.cards.Defend;
import theancientonemod.cards.Key;
import theancientonemod.cards.Ridgehand;
import theancientonemod.cards.Strike;
import theancientonemod.relics.BrokenKey;
import theancientonemod.relics.Chronometer;

import java.util.ArrayList;

import static theancientonemod.ancientOneMod.*;

public class TheAncientOne extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Ancient One"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass ANCIENT_ONE;
        @SpireEnum(name = "CHARACTER_BRONZE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_BRONZE_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheAncientOne(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }


    //In-game images
    private static final String SHOULDER_1 = characterPath("shoulder2.png"); //Shoulder 1 and 2 are used at rest sites.
    private static final String SHOULDER_2 = characterPath("shoulder.png");
    private static final String CORPSE = characterPath("corpse.png"); //Corpse is when you die.

    //EnergyOrb
    private static final String[] orbTextures = {
            imagePath("character/EnergyOrbs/BG.png"),
            imagePath("character/EnergyOrbs/BGX.png"),
            imagePath("character/EnergyOrbs/BG2.png"),
            imagePath("character/EnergyOrbs/BG3.png"),
            imagePath("character/EnergyOrbs/Floater.png"),
            imagePath("character/EnergyOrbs/Floater2.png"),
            imagePath("character/EnergyOrbs/Chain3.png"),
            imagePath("character/EnergyOrbs/Chain2.png"),
            imagePath("character/EnergyOrbs/Chain1.png"),
            imagePath("character/EnergyOrbs/ChainLock.png"), // MIDDLE
            imagePath("character/EnergyOrbs/BG.png"),
            imagePath("character/EnergyOrbs/BGX.png"),
            imagePath("character/EnergyOrbs/BG2.png"),
            imagePath("character/EnergyOrbs/BG3.png"),
    ...
    private static final float[] layerSpeeds = new float[]{
            0.0F, 20.0F, 30.0F, -40.0F, 25.0F, -35.0F, 40.0F, -20.0F, 15.0F
    };
    //Actual character class code below this point

    public TheAncientOne() {
        super(getNames()[0], Meta.ANCIENT_ONE,
                new CustomEnergyOrb(orbTextures, imagePath("character/EnergyOrbs/LockEnergyVFX.png"), layerSpeeds), //Energy Orb
                new SpriterAnimation(characterPath("animation/library/NEWAncientOne.scml"))); //Animation
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(BrokenKey.ID);
        retVal.add(Chronometer.ID);
        return retVal;
    }
    ...
    private final Color cardRenderColor = Color.BROWN.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.BROWN.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.BROWN.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
