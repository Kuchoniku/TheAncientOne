...
public class Banish extends BaseCard{
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new BanishAction(upgraded, magicNumber));
    }
    @Override
