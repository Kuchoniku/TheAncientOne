...
import theancientonemod.util.TriFunction;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return ancientOneMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ancientOneMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
    ...
    /**when a card is unlocked**/
    public void onUnLock() {

    }
    /**when the turn is shifted separately from the start of turn **/
    public void onTurnShift () {
