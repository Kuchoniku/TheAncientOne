...
import theancientonemod.potions.BasePotion;
import theancientonemod.powers.BasePower;
import theancientonemod.relics.BaseRelic;
import theancientonemod.theAncientOne.TheAncientOne;
import theancientonemod.util.GeneralUtils;
import theancientonemod.util.KeywordInfo;
...
@SpireInitializer
public class ancientOneMod implements
        EditCardsSubscriber,
    ...
    public static void initialize() {
        new ancientOneMod();
        TheAncientOne.Meta.registerColor();
    }

    public ancientOneMod() {
    ...
    private static String checkResourcesPath() {
        String name = ancientOneMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + ancientOneMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(ancientOneMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        TheAncientOne.Meta.registerCharacter();
    }
    ...
    public void receiveEditRelics() {
        RelicLibrary.rareList.removeIf((relic)->relic.relicId.equals("StoneCalendar"));
